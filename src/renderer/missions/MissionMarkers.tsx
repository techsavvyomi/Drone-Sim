...
function ZoneMark({
  ...
  // A mark on a roof is picked up from further out — the reveal below — but it
  // is lit the same way a street mark is: one column standing ON the deck. It
  // used to also hang a shaft of light under the platform, and the two together
  // read as the mark leaking through the roof in both directions.
